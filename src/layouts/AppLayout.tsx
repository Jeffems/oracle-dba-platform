          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 rounded-2xl px-4 py-3 text-left transition ${active ? "bg-cyan-500/15 text-cyan-200" : "text-slate-300 hover:bg-slate-800"}`}
              >
