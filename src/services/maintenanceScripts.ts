...
export const maintenanceScripts: MaintenanceScript[] = [
  {
    ...
    risk: "Médio",
    description:
      "Gera comandos ALTER para recompilar objetos inválidos. Execute primeiro em janela controlada.",
...
ORDER BY owner, object_type, object_name`,
  },
  {
    ...
    risk: "Baixo",
    description:
      "Lista sessões bloqueadas e a sessão bloqueadora para análise antes de qualquer ação.",
    sql: `SELECT s.sid,
       s.serial#,
       s.username,
       s.status,
...
ORDER BY s.seconds_in_wait DESC`,
  },
  {
    ...
    risk: "Alto",
    description:
      "Apenas gera o comando ALTER SYSTEM KILL SESSION. Revise e execute manualmente.",
...
WHERE s.blocking_session IS NOT NULL`,
  },
  {
    ...
    risk: "Baixo",
    description:
      "Identifica tabelas com estatísticas ausentes ou antigas para planejar coleta.",
...
ORDER BY last_analyzed NULLS FIRST`,
  },
  {
    ...
    risk: "Baixo",
    description:
      "Mostra espaço e objetos na lixeira antes de qualquer limpeza.",
